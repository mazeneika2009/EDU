...
CREATE TABLE IF NOT EXISTS emails (
  ...
  timestamp       TIMESTAMP     NOT NULL,
  isGrowthReport  SMALLINT      NOT NULL DEFAULT 0,
  isWelcome       SMALLINT      NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS quiz_answers (
  ...
  isCorrect  SMALLINT    NOT NULL DEFAULT 0,
  timestamp  TIMESTAMP   NOT NULL,
